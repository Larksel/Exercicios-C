...
int inserirFinal(Produto listaLinear[], int IA, int FA, int *IL, int *FL, Produto infoNodo);
...
int main()
{
    ...
    do
    {
        ...
        case 3:
            ...
            printf("Produto.: "); scanf("%s",infoNodo.produto);
            printf("Preço...: "); scanf("%f",&infoNodo.preco);
            inserirFinal(listaLinear, IA, FA, &IL, &FL, infoNodo);
            break;
        case 0:
